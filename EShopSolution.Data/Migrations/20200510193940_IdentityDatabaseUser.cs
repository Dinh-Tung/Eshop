...
{
    public partial class IdentityDatabaseUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("4d48a7a7-10bd-4345-a447-e9fd8c98fd4b"), "57e09bbb-3928-4f59-9230-9bedb89eea24", "Administrator role", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AppUser",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "DOB", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("bad3f12c-da61-44e6-86e7-f67fc4add9e1"), 0, "e5bd32ea-5123-40dd-a6ce-cffa2326016d", new DateTime(2020, 4, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "thanhtung29.05.98@gmail.com", true, "Dinh", "Tung", false, null, "thanhtung29.05.98@gmail.com", "admin", "AQAAAAEAACcQAAAAEGGKBPzkmq/MlbC/xtEsebNwShkmDOG/nTyaIDmWYNEz9pvoh7bk+EB8wGtNnA0j3w==", null, false, "", false, "admin" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "DateCreated",
                value: new DateTime(2020, 5, 11, 2, 14, 8, 680, DateTimeKind.Local).AddTicks(3181));
        }
    }
}
